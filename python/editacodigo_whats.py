...
def obter_configuracoes_whatsapp(EdkqZqIFCAzZKXDMjvY62sGay8A0MP7o):
    agent = {"User-Agent": 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.115 Safari/537.36'}
    api = requests.get(f"https://editacodigo.com.br/index/api-whatsapp/EdkqZqIFCAzZKXDMjvY62sGay8A0MP7o", headers=agent)
    time.sleep(1)
    api = api.text
    api = api.split(".n.")
