...
if($total_clientes > 0){
 ...
 echo "<meta http-equiv='refresh' content='0;url=email_ja_cadastrado.php'>";   
    ...
    $sql = "INSERT INTO login (nome, senha, email, tipo, dinheiro, pix, cartao, caderneta, prod_gas, prod_agua, status) VALUES ('$nome_cliente', '$senha_cliente', '$emails_cliente', '1', '$dinheiro', '$pix', '$cartao', '$caderneta', '$prod_gas', '$prod_agua', '$status')";
